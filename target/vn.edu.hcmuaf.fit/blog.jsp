...
<html lang="en">
  <head>
    <title>Bài viết | Feliciano - Website đặt bàn coffee - nhóm 40</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread" style="font-family: Tahoma;">Bản tin bài viết</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="home">Trang chủ <strong>&#8594;</strong></a></span> <span>Bài viết <strong>&#8594;</strong></span></p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              ...
              <div class="text pt-3 pb-4 px-4">
                <div class="meta">
                  <div><a href="#">11 - 06 - 2019</a></div>
                  <div><a href="#">bởi Admin</a></div>
                </div>
                <h3 class="heading"><a href="#">TIÊU ĐỀ BÀI VIẾT</a></h3>
                <p class="clearfix">
