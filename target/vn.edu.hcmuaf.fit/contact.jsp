...
<html lang="en">
  <head>
    <title>Liên hệ | Feliciano - Website đặt bàn coffee - nhóm 40</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread" style="font-family: Tahoma;">Thông Tin Liên Lạc</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="home">Trang chủ <strong>&#8594;</strong></a></span> <span>Liên hệ <strong>&#8594;</strong></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
			<div class="container">
              ...
              <div class="form-group">
                <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Chi tiết vấn đề"></textarea>
              </div>
              <div class="form-group">
                <input type="submit" value="Xác Nhận Gửi" class="btn btn-primary py-3 px-5">
              </div>
            </form>
					</div>
					<div class="col-md-6 d-flex">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.214594666049!2d106.78957301474979!3d10.871276392257226!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175276398969f7b%3A0x9672b7efd0893fc4!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBOw7RuZyBMw6JtIFRwLiBI4buTIENow60gTWluaA!5e0!3m2!1svi!2sus!4v1668272244850!5m2!1svi!2sus" width="800" height="550" style="border:0; margin: auto; padding: 0px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</div>
				</div>
			</div>
		</section>
      ...
      <div class="container">
        <div class="row d-flex contact-info">
          <div class="col-md-12 mb-4">
            <h2 class="h4 font-weight-bold">Thông tin liên lạc</h2>
          </div>
          <div class="w-100"></div>
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span>Địa chỉ:</span><br>Đường số 1, khu phố 6, phường Linh Trung, <br>Thành phố Thủ Đức, TP.HCM.</p>
            </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span>Phone:</span> <a href="tel://0839496385"><br>(+84) 839 496 385</a></p>
            </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span>Email:</span> <a href="mailto:20130468@st.hcmuaf.edu.vn"><br>20130468@st.hcmuaf.edu.vn</a></p>
            </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span>Website</span> <a href="#">www.feliciano.com.vn</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-3">
                ...
                <li class="ftco-animate"><a href="https://www.facebook.com/nguyenphi.vu.902/"><span class="icon-facebook"></span></a></li>
                <li class="ftco-animate"><a href="https://www.instagram.com/lephivu12b9/"><span class="icon-instagram"></span></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-4">
            	...
            	<p>Điền email và bấm nút "Đăng kí ngay" để nhận tin tức mới nhất cùng nhiều ưu đãi lớn (số lượng có hạn) bạn nhé.</p>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            Bản quyền &copy;<script>document.write(new Date().getFullYear());</script> thuộc về <i class="icon-heart" aria-hidden="true"></i><a href="https://colorlib.com" target="_blank"> Nhóm 40 - Môn Lập Trình Web - HK1/2022_2023</a> <br>
