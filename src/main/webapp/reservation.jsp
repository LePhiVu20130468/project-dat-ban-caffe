...
<html lang="en">
  <head>
    <title>Đặt bàn | Feliciano - Website đặt bàn coffee - nhóm 40</title>
    <meta charset="utf-8">
	  ...
	  <div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="ftco-nav">
			  <ul class="navbar-nav ml-auto">
				  ...
				  <li class="nav-item cta active"><a href="reservation" class="nav-link">Đặt bàn ngay</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread" style="font-family: Tahoma;">Đặt bàn ngay<br>Ưu đãi liền tay</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="home">Trang chủ <strong>&#8594;</strong></a></span> <span>Đặt bàn <strong>&#8594;</strong></span></p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-6 order-md-last ftco-animate makereservation p-4 p-md-5 pt-5">
          	<div class="py-md-5">
	          	<div class="heading-section ftco-animate mb-5">
		            ...
		            <h2 class="mb-4">Thông tin đăng kí</h2>
		          </div>
	            <form action="#">
	              <div class="row">
	                <div class="col-md-6">
	                  <div class="form-group">
	                    <label for="">Tên</label>
	                    <input type="text" class="form-control" placeholder="Tên của quý khách">
	                  </div>
	                </div>
<%--	                <div class="col-md-6">--%>
<%--	                  <div class="form-group">--%>
...
<%--	                </div>--%>
	                ...
	                <div class="col-md-6">
	                  <div class="form-group">
	                    <label for="">Đặt cho ngày</label>
	                    <input type="text" class="form-control" id="book_date" placeholder="Ngày">
	                  </div>
	                </div>
	                <div class="col-md-6">
	                  <div class="form-group">
	                    <label for="">Vào thời gian</label>
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="select-wrap one-third">
	                      ...
	                      <select name="" id="" class="form-control">
	                        <option value="">Số lượng yêu cầu</option>
	                ...
	                <div class="col-md-12 mt-3">
	                  <div class="form-group">
	                    <input type="submit" value="Đặt ngay" class="btn btn-primary py-3 px-5">
	                  </div>
	                </div>
	              </div>
	            </form>
