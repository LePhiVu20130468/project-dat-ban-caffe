...
<html lang="en">
<head>
    <title>Trang chủ | Feliciano - Website đặt bàn coffee - nhóm 40</title>
    <meta charset="utf-8">
...
<section class="home-slider owl-carousel js-full height">
    <div class="slider-item js-full height" style="background-image: url(./images/bg_1.jpg);">
        <div class="overlay"></div>
        <div class="container">
            <div class="row slider-text js-full height justify-content-center align-items-center"
                 data-scrollax-parent="true">

                <div class="col-md-12 col-sm-12 text-center ft-co-animate">
                    <span class="subheading">Feliciano</span>
                    <h1 class="mb-4">Bán chạy nhất VN</h1>
                </div>
    ...
    <div class="slider-item js-full height" style="background-image: url(./images/bg_2.jpg);">
        <div class="overlay"></div>
        <div class="container">
            <div class="row slider-text js-full height justify-content-center align-items-center"
                 data-scrollax-parent="true">
                ...
                <div class="col-md-12 col-sm-12 text-center ft-co-animate">
                    <span class="subheading">Feliciano</span>
                    <h1 class="mb-4">Chất lượng cao &amp; Giá tốt</h1>
                </div>
    ...
    <div class="slider-item js-full height" style="background-image: url(./images/bg_3.jpg);">
        <div class="overlay"></div>
        <div class="container">
            <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-12 col-sm-12 text-center ft-co-animate">
                    <span class="subheading">Feliciano</span>
                    <h1 class="mb-4">Phục vụ chuyên nghiệp</h1>
                </div>
...
<section class="ft-co-section ft-co-no-pt ft-co-no-pb">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="featured-menus ft-co-animate">
                                ...
                                <div class="text text-center">
                                    <h3>Cà phê, nước uống</h3>
                                    <p><span>Nguyên chất</span> - <span>Nước uống đa dạng</span></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="featured-menus ft-co-animate">
                                ...
                                <div class="text text-center">
                                    <h3>Ẩm thực 3 miền</h3>
                                    <p><span>Dân dã</span> - <span>Ngon</span> - <span>Bổ</span> - <span>Rẽ</span></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="featured-menus ft-co-animate">
                                ...
                                <div class="text text-center">
                                    ...
                                    <p><span>Hội họp</span>, <span>cưới hỏi</span>, <span>liên hoan</span>, <span>sinh nhật...</span>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5 wrap-about pt-5 pt-md-5 pb-md-3 ftco-animate">
                <div class="heading-section mb-4 my-5 my-md-0">
                    <span class="subheading">Feliciano</span>
                    <h2 class="mb-4">Website đẳng cấp nhất NLU</h2>
                </div>
                <p>Muốn nếm vị cafe phải chờ đợi pha chế, đó là nét tinh hoa được chắt chiu lại mỗi giây sống chậm của
                    cuộc đời.</p>
                <p class="time">
                    <span>Mon - Fri <strong>8 AM - 11 PM</strong></span>
                    <span><a href="#">(+84) 839496385</a></span>
                    </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row d-md-flex">
            ...
            <div class="col-md-3 text-center text-md-left">
                <p>"Non sông Việt Nam có trở nên tươi đẹp hay không, 3 đứa sinh viên này có qua môn được hay không,
                    chính là nhờ một phần lớn ở lòng nhân hậu của thầy. ^^"<br>___________<br>SV. Lê Phi Vũ</p>
            </div>
        </div>
    </div>
</section>

<hr style="width: 400px; text-align: center; background-color: #c8a97e; height: 10px;">
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
            <div class="col-md-12 text-center heading-section ftco-animate">
                <span class="subheading">Feliciano</span>
                <h2 class="mb-4" style="font-family: Tahoma;">Các dịch vụ tiện ích</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
                <div class="media block-6 services d-block">
                    ...
                    <div class="media-body p-2 mt-3">
                        <h3 class="heading" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 600;">
                            ĂN UỐNG</h3>
                        <p>Dịch vụ kèm theo khi phục vụ cà phê. Các món ăn đẳng cấp từ khắp 3 miền.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
                <div class="media block-6 services d-block">
                    ...
                    <div class="media-body p-2 mt-3">
                        <h3 class="heading" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 600;">
                            ĐẶT BÀN CÀ PHÊ</h3>
                        <p>Dịch vụ chính thức của quán.<br>Cổng thông tin dịch vụ online của quán hân hạnh phục vụ
                            24/24.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
                <div class="media block-6 services d-block">
                    ...
                    <div class="media-body p-2 mt-3">
                        <h3 class="heading" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 600;">
                            TỔ CHỨC TIỆC</h3>
                        <p>Dịch vụ kèm theo vào các ngày lễ lớn hoặc những dịp quan trong của khách hàng (cưới hỏi, sinh
                            nhật, mừng công,...).</p>
                    </div>
                </div>
            </div>
...
<section class="ftco-section">
    <div class="container">
        <div class="row no-gutters justify-content-center mb-5 pb-2">
            <div class="col-md-12 text-center heading-section ftco-animate">
                <span class="subheading">Feliciano</span>
                <h2 class="mb-4" style="font-family: Tahoma;">Toả hương trong từng giọt cà phê</h2>
            </div>
        </div>
                ...
                <div class="menus d-sm-flex ftco-animate align-items-stretch">
                    ...
                    <div class="text d-flex align-items-center">
                        <div>
                            ...
                            <p><a href="reservation" class="btn btn-primary">Order now</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="ftco-section">
    <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
            <div class="col-md-12 text-center heading-section ftco-animate">
                <span class="subheading">Feliciano</span>
                <h2 class="mb-4" style="font-family: Tahoma;">Đầu bếp đỉnh cao của bếp Việt</h2>
            </div>
        </div>
        <div class="row">
